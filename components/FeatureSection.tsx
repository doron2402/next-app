...
const FeatureSection = ({ title = 'This is the default title' }: Props) => (
  <div className="py-12 bg-blue">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="lg:text-center">
        ...
        <p className="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">Organize everything in one place</p>
